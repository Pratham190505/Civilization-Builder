  ...
  return (
    <div className="grid grid-cols-1 gap-5 xl:grid-cols-[1fr_360px]">
      ...
      <Card>
        ...
        <div className="max-h-[680px] space-y-2 overflow-y-auto px-5 pb-5">
          {stateList.map((s) => (
            <div key={s.name} className="flex items-center justify-between rounded-xl border border-border bg-background/40 p-3 hover:bg-muted">
              <div>
