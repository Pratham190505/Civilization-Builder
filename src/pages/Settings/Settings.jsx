    ...
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
      <Card>
        ...
        <div className="space-y-4 p-5 pt-0">
          ...
          <button className="rounded-lg bg-gradient-to-r from-blue-500 to-violet-500 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-blue-500/20">Save changes</button>
        </div>
      </Card>
      ...
      <Card>
        ...
        <div className="space-y-4 p-5 pt-0">
          ...
          {["Email notifications", "Push notifications", "Weekly digest"].map((p) => (
            <div key={p} className="flex items-center justify-between rounded-xl border border-border bg-background/40 p-4">
