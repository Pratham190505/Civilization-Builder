const { School, State, User, Role, MediaSubmission, SchoolRankSnapshot, SchoolScoreComponent, ScoreCategory, DistrictPerformanceSnapshot, District } = require('../models');
...
class AnalyticsController {
  async getNationalAnalytics(req, res) {
    try {
      ...
      const regionalAdminCount = await User.count({
        include: [{
          model: Role,
